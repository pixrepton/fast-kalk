...
Read root `AGENTS.md`, `knowledge/INDEX.md`, and `fast-kalk/AGENTS.md` first.
Do not use this file to override policy, memory, or runtime proof rules.

<!-- gitnexus:start -->
# GitNexus — Code Intelligence

This project is indexed by GitNexus as **fast-kalk** (362 symbols, 895 relationships, 30 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
